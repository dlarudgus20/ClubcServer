...
namespace ClubcDbCreater
{
	class Program
	{
		static string script = // ver 1
@"
...
(
	...
	Nickname nvarchar(50) NOT NULL DEFAULT '손님'
)
...
";
		static void Main(string[] args)
		{
			...
			Console.WriteLine("Start Making DB...");

			Utility.ExecSql(script, out bSuccess);

			Console.WriteLine(bSuccess ? "Success!" : "Creating DB is failed");
